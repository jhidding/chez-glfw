(library (glfw gl GL_VERSION_2_1)
  (export
    glAccum
    glActiveTexture
    glAlphaFunc
  ...
  (define glFogCoordPointer (foreign-procedure "glFogCoordPointer" (unsigned-int int uptr) void))
  (define glFogCoordd (foreign-procedure "glFogCoordd" (double) void))
  (define glFogCoorddv (foreign-procedure "glFogCoorddv" (uptr) void))
  (define glFogCoordf (foreign-procedure "glFogCoordf" (float) void))
  (define glFogCoordfv (foreign-procedure "glFogCoordfv" (uptr) void))
  ...
  (define glSecondaryColor3b (foreign-procedure "glSecondaryColor3b" (integer-8 integer-8 integer-8) void))
  (define glSecondaryColor3bv (foreign-procedure "glSecondaryColor3bv" (string) void))
  (define glSecondaryColor3d (foreign-procedure "glSecondaryColor3d" (double double double) void))
  (define glSecondaryColor3dv (foreign-procedure "glSecondaryColor3dv" (uptr) void))
  (define glSecondaryColor3f (foreign-procedure "glSecondaryColor3f" (float float float) void))
  (define glSecondaryColor3fv (foreign-procedure "glSecondaryColor3fv" (uptr) void))
  (define glSecondaryColor3i (foreign-procedure "glSecondaryColor3i" (int int int) void))
  (define glSecondaryColor3iv (foreign-procedure "glSecondaryColor3iv" (uptr) void))
  (define glSecondaryColor3s (foreign-procedure "glSecondaryColor3s" (short short short) void))
  (define glSecondaryColor3sv (foreign-procedure "glSecondaryColor3sv" (uptr) void))
  (define glSecondaryColor3ub (foreign-procedure "glSecondaryColor3ub" (unsigned-8 unsigned-8 unsigned-8) void))
  (define glSecondaryColor3ubv (foreign-procedure "glSecondaryColor3ubv" (string) void))
  (define glSecondaryColor3ui (foreign-procedure "glSecondaryColor3ui" (unsigned-int unsigned-int unsigned-int) void))
  (define glSecondaryColor3uiv (foreign-procedure "glSecondaryColor3uiv" (uptr) void))
  (define glSecondaryColor3us (foreign-procedure "glSecondaryColor3us" (unsigned-short unsigned-short unsigned-short) void))
  (define glSecondaryColor3usv (foreign-procedure "glSecondaryColor3usv" (uptr) void))
  (define glSecondaryColorPointer (foreign-procedure "glSecondaryColorPointer" (int unsigned-int int uptr) void))
  ...
  (define glWindowPos2d (foreign-procedure "glWindowPos2d" (double double) void))
  (define glWindowPos2dv (foreign-procedure "glWindowPos2dv" (uptr) void))
  (define glWindowPos2f (foreign-procedure "glWindowPos2f" (float float) void))
  (define glWindowPos2fv (foreign-procedure "glWindowPos2fv" (uptr) void))
  (define glWindowPos2i (foreign-procedure "glWindowPos2i" (int int) void))
  (define glWindowPos2iv (foreign-procedure "glWindowPos2iv" (uptr) void))
  (define glWindowPos2s (foreign-procedure "glWindowPos2s" (short short) void))
  (define glWindowPos2sv (foreign-procedure "glWindowPos2sv" (uptr) void))
  (define glWindowPos3d (foreign-procedure "glWindowPos3d" (double double double) void))
  (define glWindowPos3dv (foreign-procedure "glWindowPos3dv" (uptr) void))
  (define glWindowPos3f (foreign-procedure "glWindowPos3f" (float float float) void))
  (define glWindowPos3fv (foreign-procedure "glWindowPos3fv" (uptr) void))
  (define glWindowPos3i (foreign-procedure "glWindowPos3i" (int int int) void))
  (define glWindowPos3iv (foreign-procedure "glWindowPos3iv" (uptr) void))
  (define glWindowPos3s (foreign-procedure "glWindowPos3s" (short short short) void))
  (define glWindowPos3sv (foreign-procedure "glWindowPos3sv" (uptr) void))
